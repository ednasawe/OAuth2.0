...
Type **python project.py** to run the Flask web server. In your browser visit **http://localhost:5000** to view the restaurant menu app. (In my case I used port:8088)  You should be able to view, add, edit, and delete menu items and restaurants.
